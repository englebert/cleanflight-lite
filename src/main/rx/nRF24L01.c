...
uint8_t nrf24_readwrite(uint8_t data) {
    return softSpiTransferByte_NRF(&nrf24SoftSPIDevice, data);
}
...
void rxNRF24Init(rxRuntimeConfig_t *rxRuntimeConfig) {
    ...
    softSpiInit_NRF(&nrf24SoftSPIDevice);
