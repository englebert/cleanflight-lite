...
static void detectAndApplySignalLossBehaviour(void) {
    ...
    // debug[2] = rxFlightChannelsValideValueFromRx
    debug[2] = useValueFromRx;
#endif
...
#ifdef NRF24
    if (rxSignalReceived && !IS_RC_MODE_ACTIVE(BOXFAILSAFE)) {
#else
